  ...
  return (
    <ScreenContainer>
      <View style={styles.heightStyle}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.textStyle}>
          <View>
            <Text style={styles.titleStyle}>Tytuł ogłoszenia</Text>
            <Text style={styles.dateStyle}>Styczeń 23, 2019 10:00</Text>
            <ScrollView
              horizontal
              showsHorizontalScrollIndicator={false} style={styles.allImagesStyle}>
              <Image
